...
public class CalcolaCodiceFiscale {
	 ...
	 * fiscale calcolato. Se uno dei parametri in input Ë null o stringa vuota
	 ...
	 *         input. Se uno dei parametri in input Ë null o stringa vuota
	 *         restituisce una stringa vuota.
	 */
	...
	/**
	 * Verifica se una stringa Ë vuota.
	 * 
	 * @param s la stringa da controllare.
	 * @return true se s Ë null o se Ë di lunghezza zero o se contiene solo
	 *         spazi.
	 */
	 ...
	 *            consonanti o vocali
	 * @param cod pu√≤ essere false o true a seconda che si vogliano
	...
	/**
	 * 
	 * I cognomi che risultano composti da pi˘ parti o comunque separati od
	 ...
	 * nubile. Se il cognome contiene tre o pi˘ consonanti, i tre caratteri da
	 ...
	 * successione di caratteri. Se il nome contiene quattro o pi˘ consonanti, i
	 ...
	 * nell'ordine, la cifra delle decine e la cifra delle unit‡† dell'anno
	 ...
	 * nascita viene aumentato di quaranta unit√†, per cui esso figura con i
	 ...
	 * I valori numerici cos√¨ determinati vengono addizionati e la somma si
	...
	private static Character calcolaCharControllo(StringBuilder codfisc) {
		...
		for (int i = 0; i < codfisc.length(); i++) {
			...
			if (i % 2 == 0) {//parit√† invertita perch√® stringa √® zero aligned
	 ...
	 */
	private static final Pattern CHAR_ALLOWED = Pattern.compile("[A-Z¿»…Ã“Ÿ' ]+");
	...
	/**
	 * Utilizzato per verificare se una lettera Ë una consonante
	 */
